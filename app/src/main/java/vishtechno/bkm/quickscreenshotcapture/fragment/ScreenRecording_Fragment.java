...
public class ScreenRecording_Fragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), "/" + getResources().getString(R.string.app_name)+"/Screen Recorder");
        ...
        creation_adapter = new VISHTECHNO_Creation_Adapter(mActivity, creation_models,true);
